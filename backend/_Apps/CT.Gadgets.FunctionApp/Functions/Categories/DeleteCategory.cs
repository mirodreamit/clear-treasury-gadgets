...
public class DeleteCategory(ILogger<DeleteCategory> log, IMediator mediator, IHttpRequestProcessingService httpRequestProcessingService)
{
    ...
    private const string OperationId = $"{FeatureGlobals.Categories.Tag}-delete";
    ...
    public async Task<IActionResult> Run(
        [HttpTrigger(AuthorizationLevel.Anonymous, "delete", Route = $"{FeatureGlobals.Version1}/{FeatureGlobals.Categories.Tag}/{{id}}")] HttpRequest req,
        Guid id,
